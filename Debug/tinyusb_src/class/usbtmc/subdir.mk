...
C_SRCS += \
D:/nxp/window_workspace/tinyusb/src/class/usbtmc/usbtmc_device.c 

OBJS += \
./tinyusb_src/class/usbtmc/usbtmc_device.o 

C_DEPS += \
./tinyusb_src/class/usbtmc/usbtmc_device.d 


# Each subdirectory must supply rules for building sources it contributes
tinyusb_src/class/usbtmc/usbtmc_device.o: D:/nxp/window_workspace/tinyusb/src/class/usbtmc/usbtmc_device.c
	@echo 'Building file: $<'
