...
- pin_list:
  ...
  - {pin_num: L12, peripheral: ADC1, signal: 'IN, 9', pin_signal: GPIO_AD_B1_04, identifier: ''}
  ...
  - {pin_num: K12, peripheral: LPUART3, signal: RTS_B, pin_signal: GPIO_AD_B1_05, direction: OUTPUT}
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_B1_02_LPSPI4_PCS2,          /* GPIO_B1_02 is configured as LPSPI4_PCS2 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
...
void BOARD_InitLCDPins(void) {
  ...
  IOMUXC_SetPinConfig(
      ...
      0x01B0B0U);                             /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Enabled */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_B1_02_LPSPI4_PCS2,          /* GPIO_B1_02 PAD functional properties : */
      0x01B0B0U);                             /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
